# Lean Probability Formalizations

This repository contains two substantial Lean 4 and Mathlib formalizations in probability theory, high-dimensional geometry, and random matrix theory:
