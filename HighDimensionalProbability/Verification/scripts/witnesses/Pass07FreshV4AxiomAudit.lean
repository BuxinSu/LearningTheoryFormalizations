...
run_cmd do
  ...
  let calibrationHandle ← IO.FS.Handle.mk
    "/tmp/pass07_v4_current/axiom_calibration.tsv"
    IO.FS.Mode.write
  ...
  let moduleHandle ← IO.FS.Handle.mk
    "/tmp/pass07_v4_current/axiom_modules.txt"
    IO.FS.Mode.write
  ...
  let binderHandle ← IO.FS.Handle.mk
    "/tmp/pass07_v4_current/axiom_declaration_binders.tsv"
    IO.FS.Mode.write
  ...
  let edgeHandle ← IO.FS.Handle.mk
    "/tmp/pass07_v4_current/axiom_direct_dependencies.tsv"
    IO.FS.Mode.write
  edgeHandle.putStrLn <|
