...
| (3.38); Moore–Aronszajn theorem | A real scalar kernel has a complete Hilbert-space feature map if and only if it is positive semidefinite. | `HDP.Chapter3.scalarKernel_featureMap_iff_posSemidef` | [`Chapter3_RandomVectorsInHighDimensions.lean`](Chapter3_RandomVectorsInHighDimensions.lean) |
